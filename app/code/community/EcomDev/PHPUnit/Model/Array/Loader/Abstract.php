...
abstract class EcomDev_PHPUnit_Model_Array_Loader_Abstract implements EcomDev_PHPUnit_Model_Array_Loader_Interface
{
    ...
    /**
     * Resolves Array file path based on its filename,
     * if file is not found, it should return false
     *
     * @param string $fileName name of the file
     * @param string $relatedClassName class name from which load of file is invoked
     * @param string $type type of file (provider, fixture, expectation)
     * @return string|bool
     */
    public function resolveFilePath($fileName, $relatedClassName, $type)
    {
        if (strrpos($fileName, '.php') !== strlen($fileName) - 5) {
            $fileName .= '.php';
        }
